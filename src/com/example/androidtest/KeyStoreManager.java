...
public final class KeyStoreManager {
    ...
    private static final String KEYSTORE_FILENAME = "androidTest.keystore";
    ...
    private void load() {
        ...
        try {
            ...
            Log.d(LOG_TAG, "KeyStore.getDefaultType=" + KeyStore.getDefaultType());
    ...
    private synchronized void collectKeyManagers() throws GeneralSecurityException {
    	...
    	Log.d(LOG_TAG, "KeyManagerFactory.getDefaultAlgorithm()=" + KeyManagerFactory.getDefaultAlgorithm());
        ...
        Log.d(LOG_TAG, "mKeyManagers.length=" + mKeyManagers.length);
        Log.d(LOG_TAG, "mKeyManagers[0] instanceof X509KeyManager: " + (mKeyManagers[0] instanceof X509KeyManager));
    }
    ...
    private synchronized void collectTrustManagers() throws GeneralSecurityException {
    	...
    	Log.d(LOG_TAG, "TrustManagerFactory.getDefaultAlgorithm()=" + TrustManagerFactory.getDefaultAlgorithm());
        TrustManagerFactory tmf = TrustManagerFactory.getInstance(TrustManagerFactory
                .getDefaultAlgorithm());
        tmf.init(mKeyStore);
        mTrustManagers = tmf.getTrustManagers();
        Log.d(LOG_TAG, "mTrustManagers.length=" + mTrustManagers.length);
        Log.d(LOG_TAG, "mTrustManagers[0] instanceof X509TrustManager: " + (mTrustManagers[0] instanceof X509TrustManager));
    }
